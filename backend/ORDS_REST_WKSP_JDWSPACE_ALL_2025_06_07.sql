...
-- Schema: WKSP_JDWSPACE  Date: Sat Jun 07 11:03:43 2025 
--
...
BEGIN
  ORDS.ENABLE_SCHEMA(
      p_enabled             => TRUE,
      p_schema              => 'WKSP_JDWSPACE',
      p_url_mapping_type    => 'BASE_PATH',
      p_url_mapping_pattern => 'jdwspace',
...
exception
 ...
 when others then 
  ...
  ORDS.CREATE_ROLE(p_role_name => 'oracle.dbtools.role.autorest.WKSP_JDWSPACE');
    
  l_roles(1) := 'oracle.dbtools.autorest.any.schema';
  l_roles(2) := 'oracle.dbtools.role.autorest.WKSP_JDWSPACE';
  l_patterns(1) := '/metadata-catalog/*';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'oracle.dbtools.autorest.privilege.WKSP_JDWSPACE',
      p_roles          => l_roles,
      p_patterns       => l_patterns,
      p_modules        => l_modules,
      p_label          => 'WKSP_JDWSPACE metadata-catalog access',
      p_description    => 'Provides access to the metadata catalog of the objects in the WKSP_JDWSPACE schema.',
      p_comments       => NULL); 
